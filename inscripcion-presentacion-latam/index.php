			...
			if ( bValid ) {
				...
				function( data ) {
					  ...
					  if(arr_return[0] == 0){
						...
						document.location.href = "video_juanrueda_presentacion.php";
...
<div id="dialog-form" title="Autenticación">
  ...
  </form> <p class="validateTips">Ingresa tu correo electrónico para que puedas ver el video completo de la presentación.</p>
</div>
