...
To use these stylesheets, rename the files and juan_rueda with the name of your theme.
...
juan_rueda-alpha-default-narrow.css  
...
juan_rueda-alpha-default-normal.css
...
juan_rueda-alpha-default-wide.css
